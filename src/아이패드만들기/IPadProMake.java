...
public class IPadProMake {
    ...
    static int cnt = 0; //클래스 변수 : 객체 시 생성되지 않고 클래스 생성 시 만들어 짐
    ...
    public boolean continueOrder() {
        ...
        if (isContinue.equalsIgnoreCase("yes")) return false;
            return true;
    ...
    public void setName() {
        Scanner sc = new Scanner(System.in);
        System.out.print("각인서비스를 신청하시겠습니까? ");
    ...
    // 일련 번호 만들기 : iPad + 11/13 + 128/256/512/1024
